...
//       routineName,
//       selectedRoutineType:
//         routineTypeMapping[selectedRoutineType] || selectedRoutineType, // Use mapped value
//       finalGoal,
//       stepGoalUnit,
//       selectedDuration,
//       selectedUnit,
...
//           className="setroutine-back-button"
//         />
...
//           <button
//             className={`setroutine-set-button ${
//               selectedRoutineType ? "selected" : ""
//             }`}
//             onClick={handleClick}
//           >
...
//                 <h1 className="exclam-text">
//                   루틴 기간동안 점진적으로 수행할 단위를 입력해요
//                 </h1>
//               </div>
//             </div>
//           </>
...
//                         {unit}
//                         {selectedUnit === unit && (
//                           <GreenCheck className="green-check-icon" />
//                         )}
//                       </div>
//                     ))}
//                   </div>
...
//                 <button
//                   className="dropdown-button day"
//                   onClick={toggleAmountDropdown}
//                   type="button"
//                 >
//                   {selectedAmount}
//                   <DropBoxArrow
//                     className={`up-arrow ${isAmountDropdownOpen ? "open" : ""}`}
//                   />
//                 </button>
...
//           <button
//             type="submit"
//             className="setroutine-save-button"
...
//               <li
//                 onClick={() =>
//                   handleRoutineTypeSelect("시간 목표를 달성하는 방식")
//                 }
//               >
//                 시간 목표를 달성하는 방식
//               </li>
//               <li
//                 onClick={() =>
//                   handleRoutineTypeSelect("칼로리 목표를 달성하는 방식")
//                 }
//               >
//                 칼로리 목표를 달성하는 방식
//               </li>
//               <li
//                 onClick={() =>
//                   handleRoutineTypeSelect("산책 거리 목표를 달성하는 방식")
//                 }
//               >
//                 산책 거리 목표를 달성하는 방식
//               </li>
...
//       routineType:
//         routineTypeMapping[selectedRoutineType] || selectedRoutineType,
    ...
    <div className="setroutine-container">
      ...
      <form className="setroutine-wrapper" onSubmit={handleSubmit}>
        <div className="setroutine-set-container">
          <div className="setroutine-set-title">루틴 이름</div>
          <div
            className={`setroutine-set-input ${
              isFocused.routineName ? "focused" : ""
            }`}
          >
            <input
              className="set-font"
              ...
              onChange={(e) => setRoutineName(e.target.value)}
              onFocus={() =>
                setIsFocused((prev) => ({ ...prev, routineName: true }))
              }
              onBlur={() =>
                setIsFocused((prev) => ({ ...prev, routineName: false }))
              }
            />
          </div>
        </div>
        ...
        {selectedRoutineType && (
          <>
            <div className="setroutine-set-container sub-page">
              ...
              >
                <input
                  ...
                  onChange={(e) => setFinalGoal(e.target.value)}
                  onFocus={() =>
                    setIsFocused((prev) => ({ ...prev, finalGoal: true }))
                  }
                  onBlur={() =>
                    setIsFocused((prev) => ({ ...prev, finalGoal: false }))
                  }
                />
                <span className="unit">{getFinalGoalUnit()}</span>
              </div>
            ...
            <div className="setroutine-set-container sub-page">
              ...
              <div
                className={`setroutine-set-input ${
                  isFocused.stepGoalUnit ? "focused" : ""
                }`}
              >
                <input
                  className="set-font"
                  ...
                  onChange={(e) => setStepGoalUnit(e.target.value)}
                  onFocus={() =>
                    setIsFocused((prev) => ({ ...prev, stepGoalUnit: true }))
                  }
                  onBlur={() =>
                    setIsFocused((prev) => ({ ...prev, stepGoalUnit: false }))
                  }
                />
                <span className="unit">{getFinalGoalUnit()}</span>
              </div>
