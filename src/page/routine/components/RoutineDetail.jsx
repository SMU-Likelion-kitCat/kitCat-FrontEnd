...
//           )
//           setRoutine({ ...selectedRoutine, ...routineDetail })
//         }
//       } catch (error) {
//         console.error("routine data 가져오기 실패", error)
//       }
//     }
...
//       const week = i + 1
//       const records =
//         routine.weekRecords?.find((record) => record.week === week) || {}
...
//           <Calendar_G className="detail-icon calendar" />
//           <h1 className="detail-info">
//             {routine.routineTerm} · {routine.routineBase}에 {routine.count}번
//           </h1>
//         </div>
//         <div className="routine-detail-info-wrap">
...
//               <p className="detail-week-info">
//                 {goal}
//                 {getUnitDisplay(routine.routineType)} 산책
//               </p>
//             </div>
//           ))}
//         </div>
